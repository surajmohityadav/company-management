					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-6">
								...
								<label for="" class="control-label border-bottom border-primary">Cost</label>
<p class="ml-2 d-list"><b><?php echo $cost ?></b></p>

<label for="" class="control-label border-bottom border-primary">Total Amount</label>
<p class="ml-2 d-list"><b><?php echo $cost - ($cost * $discount/100) ?></b></p>
							</div>
							<div class="col-md-6">
								...
								<label for="" class="control-label border-bottom border-primary">Discount</label>
<p class="ml-2 d-list"><b><?php echo $discount ?>%</b></p>
							</div>
						</div>
...
<?php else: ?>
<button class="btn btn-primary" disabled><i class="fa fa-print"></i> Print</button>
<?php endif; ?>
<script>
function printContent() {
  var printDiv = document.getElementsByClassName("card")[0].innerHTML;
